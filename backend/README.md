...
## Project Structure
    ...
    ├── ready_set_teen_33241  # Django project configurations
...
1. Clone this repo and `cd ready_set_teen_33241`
...
2. Clone this repo and `cd ready_set_teen_33241`
